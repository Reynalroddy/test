...
const Dashboard = () => {
    ...
    const prods=[
        {desc:"MDA",bill:'#456788',status:'success',method:"online"},
        {desc:"MLA",bill:'#456787',status:'pending',method:"-"},
        {desc:"MDA",bill:'#456788',status:'success',method:"online"}
    ]
                ...
                <div className="col-12">
                    <div className="surface-card shadow-2 border-round flex p-3 flex-column">
                        <div className="grid">
                            ...
                            <div className="col-12 md:col-6 lg:col-6 py-4 p-3">
                            ...
                            <div className="col-12 md:col-6 lg:col-6 py-4 flex align-items-center justify-content-center">
                                <div className="p-3  w-full lg:w-15rem " style={{ borderRadius: '12px', backgroundColor: '#286C65' }}>
                                    {/* <span className="inline-flex justify-content-center align-items-center bg-purple-600 border-circle mb-3" style={{ width: '49px', height: '49px' }}>
                                                    <i className="pi pi-map-marker text-xl text-white"></i>
                                                </span> */}
    ...
    <div className="col-12 lg:col-12 surface-card shadow-2 border-round mx-auto p-3 flex flex-column">
